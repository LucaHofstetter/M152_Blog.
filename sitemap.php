									...
									<div class="row gtr-50 gtr-uniform">
										<div class="col-12">
											<span class="image fit">
												<img src="images/svgs/Sitemap.svg" alt="" />
											</span>
										</div>
									</div>
							...
							<section id="cta" class="wrapper style4">
								<div class="inner">
									<header>
										...
										<p>Hier findest du ein Q&A zum Thema Urheberrecht.</p>
									</header>
									<ul class="actions stacked">
										<li><a href="urheberrecht.php" class="button fit primary">Mehr erfahren</a></li>
									</ul>
								</div>
							</section>
					</article>
